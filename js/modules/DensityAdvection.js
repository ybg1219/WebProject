...
import density_advection_frag from "./glsl/sim/densityAdvection.frag";
import ShaderPass from "./ShaderPass";

import * as THREE from "three";


export default class DensityAdvection extends ShaderPass{
    constructor(simProps){
        super({
            material: {
                vertexShader: face_vert,
                fragmentShader: density_advection_frag,
                uniforms: {
                    boundarySpace: {
